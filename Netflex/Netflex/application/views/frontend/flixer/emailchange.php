...
<div class="container" style="margin-top: 90px;">
	<div class="row">
		...
		<?php endif;?>
		<div class="col-lg-12">
			<h3 class="black_text" style="background-color: black; color: white;"><?php echo get_phrase('Change_Email');?></h3>
			<hr>
		</div>
		<div class="col-lg-5">
			<form method="post" action="<?php echo base_url();?>index.php?browse/emailchange">
				...
				<div class="black_text" style="background-color: black; color: white; padding: 10px 0px 10px 10px; width:100%;">
				...
				<div class="black_text">
					<input type="email" name="new_email" style="padding: 10px; width:100%; background-color: black; color: white;" />
				</div>
				<div class="" style="margin-top: 20px;">
					<?php echo get_phrase('Current_Password');?>
				</div>
				<div class="black_text">
					<input type="password" name="old_password" style="padding: 10px; width:100%; background-color: black; color: white;" />
				</div>
				<br>
