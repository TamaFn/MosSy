...
<div class="mobile_responsive" style="font-weight: bold;color: #fff;">
		...
		<h5 class="mobile_responsive_sort_description" style="color: #ffffff; max-width: 900px;"><?php echo $featured_movie->description_short;?></h5>
		...
		<a href="<?php echo base_url();?>index.php?browse/playmovie/<?php echo $featured_movie->movie_id;?>" 
			class="btn btn-danger btn-lg" style="font-size: 20px; max-width: 200px;"> 
		...
		<a href="#" class="btn  btn-lg btn_opaque" style="max-width: 200px; background-color: rgba(0, 0, 0, 0.1);  border-radius: 4px;"
