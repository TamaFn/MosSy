...
<div class="container" style="margin-top: 30px;">
	...
	<div class="col-lg-5">
		<button class="btn btn-danger btn-md" id='watch_button' style="font-size: 16px; margin-top: 20px; margin-right:20px; border-radius: 4px;" onclick="divToggle()">
		...
		<a href="#" class="btn btn-danger btn-md" style="font-size: 16px; margin-top: 20px; border-radius: 4px; background-color: rgba(0, 0, 0, 0.1); border: 1px solid #939393;" onclick="process_list('movie', 'add', <?php echo $row['movie_id'];?>)">
			<i class="fa fa-plus"></i> <?php echo get_phrase('Add_to_My_list');?>
		</a>
		</span>
		<span id="mylist_delete_button" style="display:none;">
		<a href="#" class="btn btn-default btn-md" style="font-size: 16px; margin-top: 20px; border-radius: 4px; background-color: rgba(0, 0, 0, 0.1); border: 1px solid #939393;" onclick="process_list('movie', 'delete', <?php echo $row['movie_id'];?>)">
	...
	<div class="bs-component">
		...
		<div style="display: flex; flex-wrap: wrap;">
			...
			<div style="text-align:center; color: #fff; font-weight: bold; margin: 5px;">
				<img src="<?php echo $this->crud_model->get_actor_image_url($actor); ?>" style="height: 160px; margin:5px;" />
				<br>
				<a href="<?php echo base_url('index.php?browse/filter/movie/all/' . $actor . '/all/all'); ?>" style="color: white;"><?php echo $this->db->get_where('actor', ['actor_id' => $actor])->row()->name; ?></a>
			</div>
			<?php
			}
			?>
		...
		<div style="text-align:left; color: #fff; font-weight: bold;">
			...
			<img src="<?php echo base_url('assets/global/director/' . $director_id . '.jpg'); ?>" style="height: 160px; margin:5px;" />
			<br>
