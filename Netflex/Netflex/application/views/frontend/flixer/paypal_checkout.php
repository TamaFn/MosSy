...
<script>
    ...
    function simulatePayPalPayment() {
        // Directly call the onAuthorize function
        onPaymentAuthorized();
    }

    // Function to handle payment authorization
    ...
    paypal.Button.render({
        ...
        onAuthorize: function(data, actions) {
            ...
            return new Promise(function(resolve, reject) {
                ...
                // Call the function to handle payment authorization
                onPaymentAuthorized();
            });
        }
    ...
    // Simulate button click for demo purposes
    $(document).ready(function() {
        // Example: Simulate button click after 2 seconds (adjust as needed)
        setTimeout(function() {
            onPaymentAuthorized(); // Simulate payment authorization
        }, 2000); // Change the delay as needed (milliseconds)
    });
</script>
