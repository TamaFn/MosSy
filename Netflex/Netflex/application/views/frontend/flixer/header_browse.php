...
<div class="navbar navbar-default navbar-fixed-top <?php echo $nav_type;?>" >
	<div class="container" style=" width: 100%;">
		<div class="navbar-header">
			<a href="<?php echo base_url();?>index.php?browse/home" class="navbar-brand" style="padding: 10px 15px">
				<img src="<?php echo base_url();?>/assets/global/logo2.png" style=" height: 30px; margin-top:0px" />
			</a>
			...
			<form class="navbar-form navbar-right" method="post" action="<?php echo base_url();?>index.php?browse/search">
				<div class="form-group">
					<input type="text" class="form-control" placeholder="Titles"
						style="background-color: #FFF; border: 1px solid #FFF; height:35px;" name="search_key">
				</div>
