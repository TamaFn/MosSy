...
<div class="container" style="margin-top: 90px;">
	<div class="row">
		<div class="col-lg-12">
			<h3 class="black_text" style="background-color:black; color:white;"><?php echo get_phrase('cancel_your_membership');?>?</h3>
			<hr>
		</div>
		<div class="col-lg-8">
			<h4 class="black_text" style="background-color:black; color:white;"><?php echo get_phrase('Click_Finish_Cancellation_below_to_cancel_your_membership');?></h4>
			<ul class="black_text" style="background-color:black; color:white;">
				<li>
