<!-- TOP LANDING SECTION -->
<div style="height:93vh;width:100%;background-image: url(<?php echo base_url().'assets/frontend/flixer/images/screen_bg.png';?>)">
	<!-- logo -->
	<div style="float: left;">
		<a href="<?php echo base_url();?>index.php?home">
		<img src="<?php echo base_url();?>/assets/global/logo2.png" style="margin: 10px 18px; width: 160px;" />
		</a>
	</div>
	<div style="float: right;margin: 35px 18px; height: 50px;" class="hidden-xs">
		<a href="<?php echo base_url();?>index.php?home/signin" class="btn btn-danger" style="border-radius: 10px; width:100px;"><?php echo get_phrase('sign_in');?></a>
	</div>
	...
	<div style="font-size: 85px;font-weight: bold;clear: both;padding: 100px 0px 0px 0px; text-align:center; color: #fff;" class="hidden-xs">
		...
		<a href="<?php echo base_url();?>index.php?home/signup" class="btn btn-danger btn-lg"
			...
			<?php echo get_phrase('JOIN_FREE_FOR_A_DAY');?>
