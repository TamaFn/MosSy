...
<div class="container" style="margin-top: 90px;">
	<div class="row">
		...
		<div class="col-lg-12">
			<h3 class="black_text" style="background-color: black; color:white;"><?php echo get_phrase('Account');?></h3>
			<hr>
		</div>
		<div class="col-lg-12">
			<div class="row">
				<div class="col-lg-5">
					<span style="font-size: 20px; color:white;"><?php echo get_phrase('MEMBERSHIP_AND_BILLING');?></span>
					<br>
					<?php
				...
				<div class="col-lg-7">
					<div class="row" style="margin: 5px;">
						<div class="pull-left black_text" style="background-color:black; color:red; font-wight">
			...
			<div class="row">
				...
				<div class="col-lg-7">
					<div class="row" style="margin: 5px;">
						<div class="pull-left black_text" style="background-color:black;">
