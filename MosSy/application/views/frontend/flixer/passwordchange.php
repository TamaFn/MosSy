...
<div class="container" style="margin-top: 90px;">
	<div class="row">
		...
		<?php endif;?>
		<div class="col-lg-12">
			<h3 class="black_text" style="background-color: black; color: white;"><?php echo get_phrase('Change_Password');?></h3>
			<hr>
		</div>
		<div class="col-lg-5">
			<form method="post" action="<?php echo base_url();?>index.php?browse/passwordchange">
				...
				<div class="black_text">
					<input type="password" name="new_password" style="padding: 10px; width:100%; background-color: black; color: white;" />
				</div>
				<br>
