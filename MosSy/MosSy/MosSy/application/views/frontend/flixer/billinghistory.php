...
<div class="container" style="margin-top: 90px;">
	<div class="row">
		<div class="col-lg-12">
			<h3 class="black_text" style="background-color:black; color:white;"><?php echo get_phrase('billing_history');?></h3>
			<hr>
		</div>
		<div class="col-lg-8">
			<table class="table table-striped table-hover" style="color: #000;">
				<tbody>
					<tr style="background-color: red; color: white; border-bottom: 1px; font-weight:bold;">
